      ...
      <main className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
          <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-bold text-slate-800 mb-3">Chapter Tracking</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
            <div className="text-5xl mb-4">🔥</div>
            <h3 className="text-xl font-bold text-slate-800 mb-3">Daily Streaks</h3>
            <p className="text-slate-600">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
            <div className="text-5xl mb-4">✨</div>
            <h3 className="text-xl font-bold text-slate-800 mb-3">Journal Insights</h3>
            <p className="text-slate-600">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
            <div className="text-5xl mb-4">🏅</div>
            <h3 className="text-xl font-bold text-slate-800 mb-3">Achievement Badges</h3>
            <p className="text-slate-600">
          ...
          <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
            <div className="text-5xl mb-4">💾</div>
            <h3 className="text-xl font-bold text-slate-800 mb-3">Local Storage</h3>
            <p className="text-slate-600">
