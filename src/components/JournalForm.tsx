...
export default function JournalForm({ onEntryAdded }: JournalFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white rounded-xl p-6 shadow-md">
            <h2 className="text-2xl font-bold text-slate-800 mb-6">What touched you today?</h2>

            {/* Book Selector */}
            <div className="mb-6">
                <h3 className="text-sm font-semibold text-slate-700 mb-3">Select Book</h3>
            ...
            <div className="mb-6">
                ...
                <div className="grid grid-cols-6 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 gap-2 max-h-48 overflow-y-auto p-2 bg-slate-50 rounded-lg">
                    {chapters.map((ch) => {
            ...
            {/* Entry Textarea */}
            <div className="mb-4">
                <label htmlFor="journal-entry" className="block text-sm font-semibold text-slate-700 mb-2">
                ...
                <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border-2 border-slate-200 bg-white text-slate-800 
